...
class CaptchaValidator
{
     ...
     */
    public function __construct(TranslatorInterface $translator, SessionInterface $session, $invalidMessage, $bypassCode, $humanity, \Symfony\Component\DependencyInjection\ContainerInterface $container)
    {
