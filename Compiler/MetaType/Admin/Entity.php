...
class Entity extends \Symforce\AdminBundle\Compiler\MetaType\Type {
    ...
    const USED_NAME =  ' sf symforce app tmp temp put get post file save admin loader root parent child children tree id list create update delete view action batch action property filter search cache options accessor controller request object object_id _sf_admin_route_parameters _sf_admin_route_parents ';
